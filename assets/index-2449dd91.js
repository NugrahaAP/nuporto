...
function Re(e) {
  ...
  return {
   ...
   <div class="gallery svelte-y9n4lg"><div class="hidrogen svelte-y9n4lg"><h2>Experiment with gradient</h2> 
        ...
        <img style="align-self: center;margin-top:5em;margin-bottom:5em;" width="854" height="480" src="/nuporto/hidrogen/hydrogen_atom.png" alt=""/> 
    ...
    <div class="hidrogen svelte-y9n4lg"><h2>Animasi TV Commercial KPU Provinsi Jambi</h2> 
        ...
        <img style="align-self: center;margin-top:5em;margin-bottom:5em;" width="854" height="480" src="/nuporto/kpu/kpu_ae.png" alt=""/> 
    ...
    <div class="hidrogen svelte-y9n4lg"><h2>Animasi belajar mengenal angka</h2> 
        ...
        <img style="align-self: center;margin-top:5em;margin-bottom:5em;" width="854" height="480" src="/nuporto/pensilkertaskids/mengenal_angka.png" alt=""/> 
    ...
    <div class="hidrogen svelte-y9n4lg"><h2>Konten youtube Gado Gado Media</h2> 
        ...
        <img style="align-self: center;margin-top:5em;margin-bottom:5em;" width="854" height="480" src="/nuporto/ggm/valoran.png" alt=""/> 
